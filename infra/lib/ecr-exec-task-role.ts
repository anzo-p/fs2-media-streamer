...
export class EcsTaskExecutionRoleStack extends cdk.NestedStack {
  ...
  constructor(scope: Construct, id: string, repositories: string[], props?: cdk.StackProps) {
    super(scope, id, props);

    const ecsTaskExecutionRole = new iam.Role(this, 'ECSTaskExecutionRoleForAudioStreamer', {
